...
exports.incrementNumberObjectByOne =
  exports.getDateItems =
  exports.prettyPrint =
  exports.getResolution =
  exports.validatePendingUpdate =
  exports.validateID =
    void 0;
...
var getResolution = function (resolution) {
  if (resolution) {
    return types_1.resolutionValues.find(function (value) {
      return value.toString() === resolution.S;
    });
  }
};
