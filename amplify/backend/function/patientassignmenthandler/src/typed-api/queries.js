...
var getPatientAssignment = function (variables) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, appSyncRequest_1.request)({
                    query: queries_1.getPatientAssignment,
                    variables: variables
                }, types_1.AppSyncUrl)];
...
var getClinicianPatientMap = function (variables) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, appSyncRequest_1.request)({
                    query: queries_1.getClinicianPatientMap,
                    variables: variables
                }, types_1.AppSyncUrl)];
            case 1: return [2 /*return*/, (_a.sent())];
        }
