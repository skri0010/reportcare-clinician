 ...
 */
class DisplayNewAlerts extends Activity {
  constructor() {
    super(ActionFrameIDs.UXSA.DISPLAY_NEW_ALERTS);
  }
...
// Preconditions for activating the DisplayNewAlerts class
...
// Action Frame for DisplayNewAlerts class
const af_DisplayNewAlerts = new Actionframe(
  `AF_${ActionFrameIDs.UXSA.DISPLAY_NEW_ALERTS}`,
  [rule1, rule2],
  new DisplayNewAlerts()
);

export default af_DisplayNewAlerts;
